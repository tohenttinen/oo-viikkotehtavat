...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(0, 0, 80, 18));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(0, 20, 80, 18));
        lcdNumber = new QLCDNumber(centralwidget);
        lcdNumber->setObjectName("lcdNumber");
        lcdNumber->setGeometry(QRect(80, 10, 41, 23));
        ...
        menuCounter->setObjectName("menuCounter");
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        menuCounter->setTitle(QCoreApplication::translate("MainWindow", "Counter", nullptr));
    } // retranslateUi
